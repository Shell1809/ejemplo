        ...
        document.getElementById('form-registro').addEventListener('submit', function(event) {
            ...
            .then(function(data) {
                if (data.success) {
                    ...
                    // CORRECCIÓN REDIRECCIÓN: Redirecciona directo a la raíz del proyecto para evitar errores de método
                    setTimeout(function() {
            ...
            .catch(function(error) {
                ...
                document.getElementById('error-message').innerText = "Ocurrió un inconveniente al procesar el formulario en el servidor (422/500).";
                errorAlert.style.display = 'block';
            });
        });
    </script>
