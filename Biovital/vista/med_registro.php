...
<body>
                        ...
                        <div class="col-md-6">
                            <div class="form-group required">
                                ...
                                <select class="form-control" id="ciudad" name="ciudad" required>
                                    <option value="Barquisimeto" selected>Barquisimeto</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group required">
                                ...
                                <input type="password" class="form-control" id="pass" name="pass" minlength="6" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group required">
                                <label for="confirm_pass">Confirmar Contraseña</label>
                                <input type="password" class="form-control" id="confirm_pass" name="confirm_pass" minlength="6" required>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('form-registro').addEventListener('submit', function(event) {
            ...
            // Validación Frontend estricta de contraseñas
            ...
            if (password !== confirmPassword) {
                document.getElementById('error-message').innerText = "Validación local: Las contraseñas ingresadas no coinciden.";
            ...
            .then(function(data) {
                if (data.success) {
                    ...
                    // CORRECCIÓN REDIRECCIÓN: Envía directo a la raíz del proyecto para evitar errores 405
                    setTimeout(function() {
            ...
            .catch(function(error) {
                ...
                document.getElementById('error-message').innerText = "Ocurrió un inconveniente al procesar el formulario en el servidor.";
                errorAlert.style.display = 'block';
            });
        });
    </script>
